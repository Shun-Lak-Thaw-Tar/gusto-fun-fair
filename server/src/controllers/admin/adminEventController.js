...
const featureFlagsSchema = z.object({ memoriesEnabled: z.boolean().optional(), eventPageEnabled: z.boolean().optional(), crushLettersEnabled: z.boolean().optional(), quizEnabled: z.boolean().optional() }).strict().refine((value) => Object.keys(value).length > 0, { message: 'At least one feature flag is required' });
